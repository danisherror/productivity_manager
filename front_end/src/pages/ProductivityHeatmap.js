  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      {loading ? (
        ...
        <CalendarHeatmap
          ...
          tooltipDataAttrs={value => {
            ...
            return {
              'data-tip': `${value.date}: Productivity ${value.count}`,
            };
          }}
          showWeekdayLabels
        />
      ...
      <div className="flex justify-center gap-4 mt-6">
        <div className="w-5 h-5 rounded bg-red-600" title="0" />
        <div className="w-5 h-5 rounded bg-gray-200" title="0" />
        <div className="w-5 h-5 rounded bg-green-200" title="1–2" />
        <div className="w-5 h-5 rounded bg-green-400" title="3–5" />
        <div className="w-5 h-5 rounded bg-green-600" title="6–8" />
        <div className="w-5 h-5 rounded bg-green-800" title="9+" />
      </div>
    </div>
  );
}
